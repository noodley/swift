...
class TestObjectController(unittest.TestCase):
    ...
    def test_PUT_connect_exceptions(self):
        ...
        with save_globals():
            ...
            test_status_map((200, 200, 200, 200, 200, 201, 201, -2),
                            201)  # expect timeout
            test_status_map((200, 200, 200, 200, 200, 201, 201, -3),
                            201)  # error limited
    ...
    def test_POST_as_copy(self):
        with save_globals():
            ...
            def test_status_map(statuses, expected):
                ...
                expected = str(expected)
                self.assertEquals(res.status[:len(expected)], expected)
            test_status_map((200, 200, 200, 200, 200, 200, 200, 200, 202, 202,
                            202), 202)
            test_status_map((200, 200, 200, 200, 200, 200, 200, 200, 202, 202,
                            500), 202)
            test_status_map((200, 200, 200, 200, 200, 200, 200, 200, 202, 500,
                            500), 503)
            test_status_map((200, 200, 200, 200, 200, 200, 200, 200, 202, 404,
                            500), 503)
            test_status_map((200, 200, 200, 200, 200, 200, 200, 200, 202, 404,
                            404), 404)
            test_status_map((200, 200, 200, 200, 200, 200, 200, 200, 404, 500,
                            500), 503)
            test_status_map((200, 200, 200, 200, 200, 200, 200, 200, 404, 404,
                            404), 404)
    ...
    def test_POST_as_copy_meta_val_len(self):
        with save_globals():
            controller = proxy_server.ObjectController(self.app, 'account',
                'container', 'object')
            proxy_server.http_connect = \
                fake_http_connect(200, 200, 200, 200, 200, 200, 200, 200, 202,
                                  202, 202)
                #                 acct cont head head head objc objc objc obj
                #                 obj  obj
            req = Request.blank('/a/c/o', {}, headers={
                                            'Content-Type': 'foo/bar',
                                            'X-Object-Meta-Foo': 'x' * 256})
    ...
    def test_POST_as_copy_meta_key_len(self):
        with save_globals():
            controller = proxy_server.ObjectController(self.app, 'account',
                'container', 'object')
            proxy_server.http_connect = \
                fake_http_connect(200, 200, 200, 200, 200, 200, 200, 200,
                                  202, 202, 202)
    ...
    def test_chunked_put(self):
        ...
        with save_globals():
            proxy_server.http_connect = fake_http_connect(201, 201, 200, 200,
                                                          200, 201, 201)
            controller = proxy_server.ObjectController(self.app, 'account',
                'container', 'object')
            req = Request.blank('/a/c/o', environ={'REQUEST_METHOD': 'COPY'},
    ...
    def test_mismatched_etags(self):
        with save_globals():
            ...
            self.app.update_request(req)
            proxy_server.http_connect = fake_http_connect(200, 200, 200, 200,
                200, 201, 201, 201, etags=[None, None, None, None,
            ...
            self.app.update_request(req)
            proxy_server.http_connect = fake_http_connect(200, 200, 200, 422,
                422, 503, etags=[None, None, None,
                       '68b329da9893e34099c7d8ad5cb9c940',
                       '68b329da9893e34099c7d8ad5cb9c941',
                       None,
                       None])
